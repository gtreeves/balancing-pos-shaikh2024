...
% k = 0.1*rand(1,10);
%
load('NCPs_along_Ppase.mat')

% load('Receptor_levels_24.mat')
load("receptor_input_var_freq_logspace.mat")
% Rmax = total_conc_max;
% Rmin = total_conc_min;
%
Rmax = F_max;
...
writetable(table(loc,locj,phi,trise,NAR,active_trimer,...
...
%     try
        ...
        writetable(table(i,j,phi,trise,NAR,active_trimer,...
