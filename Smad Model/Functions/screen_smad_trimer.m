function screen = screen_smad_trimer(Rnoise,CIF,PPase,Smad1tot,Smad4tot,k,tspan,i,j) 
%intial conditions
%G=EGFP-SMad2
...
%     tl = tiledlayout(1,3);
%     nexttile
%     plot(t/3600,active_trimer_dynamic,'LineWidth',2)
%     hold on
%     plot(t_delta/3600,active_trimer_dynamic_delta,'LineWidth',2)
%     tmax = ceil(t(end)/3600);
%     xticks(0:2:tmax)
...
%     nexttile
%     yyaxis right
%     plot(tnoise/3600,Rnoise,'LineWidth',0.5)
%     hold on
%     yyaxis left
...
%     end
%     saveas(gcf,['Profiles_',num2str(j),'/Profile_',num2str(i),'_',num2str(j),'.png'])
% %     close all
% end
